...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_params):
    a, fc_cache = affine_forward(x, w, b)
    a_batchnorm, batchnorm_cache = batchnorm_forward(a, gamma, beta, bn_params)
    out, relu_cache = relu_forward(a_batchnorm)
...
def affine_bn_relu_backward(dout, cache):
    ...
    da = relu_backward(dout, relu_cache)
    da_batch, dgamma, dbeta = batchnorm_backward(da, batchnorm_cache)
